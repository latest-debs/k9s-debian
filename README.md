...
[![Release](https://img.shields.io/github/v/release/latest-debs/k9s-debian)](https://github.com/latest-debs/k9s-debian/releases)
[![Build](https://github.com/latest-debs/k9s-debian/actions/workflows/release.yml/badge.svg)](../../actions)
...
```sh
sudo apt install ./k9s_*.deb
```

## Verify

```sh
apt-cache policy k9s
k9s --version
```
...
For issues with k9s itself, see
